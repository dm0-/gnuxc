...
%install
install -dm 755 %{buildroot}%{_docdir}/gnuxc
...
install -dm 755 %{buildroot}%{root}/sys-root%{_datadir}/X11
...
install -Dpm 644 config.site \
    %{buildroot}%{root}/sys-root%{_datadir}/config.site
