...
rm -f %{buildroot}%{gnuxc_libdir}/libfontenc.la
...
%{gnuxc_libdir}/libfontenc.so
%{gnuxc_libdir}/pkgconfig/fontenc.pc

%files static
%{gnuxc_libdir}/libfontenc.a
